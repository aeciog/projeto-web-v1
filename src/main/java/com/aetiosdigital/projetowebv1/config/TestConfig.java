...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2023-02-10T13:30:07Z"), u1);
        Order o2 = new Order(null, Instant.parse("2023-02-11T14:30:10Z"), u2);
        Order o3 = new Order(null, Instant.parse("2023-02-12T15:30:22Z"), u1);
